define(['plugins/http', 'durandal/app', 'knockout', './rsvp'], function (http, app, ko, rsvp) {
    ...
    var vm = {
        ...
        activate: function () {
            ...
            self.hotels.push(new self.newHotel("Hilton Orrington", "1710 Orrington Ave", "Evanston, IL 60201", "847-866-8700", "Please reference the DeVere/Xu wedding", "200", "http://www3.hilton.com/en/hotels/illinois/hilton-orrington-evanston-ORDOEHF/index.html"));
